...
/*class create_one extends Cylinder{
    public $img = "img/cylinder1.jpg";
    function data(){
        $img = $this->img;
...
<body>
<a href="index.php"><img src="img/cylinder1.jpg" alt=""></a>
<div>
    <a href="index.php"><img src="img/cylinder1.jpg" alt="" id="a1"></a>
